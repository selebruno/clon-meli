...
export default function HomeButtons() {
    return (
        <Stack border="1px solid #D6d6d6" padding={5} direction="row"  spacing={20} width="100%" alignItems="center" justifyContent="center" marginTop="2rem">
        <Stack cursor="pointer" alignItems="center">
            ...
            <Text fontSize="xs" color="#3483fa">Ver promociones bancarias</Text>          
        </Stack>
        <Stack cursor="pointer"  alignItems="center">
            <Stack direction="row" alignItems="center">
            <Image src="https://res.cloudinary.com/dbduj98i3/image/upload/v1635284886/credit-card_tlyfij.svg"/>
            ...
            <Text fontSize="xs" color="#3483fa">Ver más</Text>          
        </Stack>
        <Stack cursor="pointer"  alignItems="center">
            <Stack direction="row" alignItems="center">
            ...
            <Text fontSize="xs" color="#3483fa">Conocé Mercado Crédito</Text>          
        </Stack>
        <Stack cursor="pointer"  alignItems="center">
            <Stack direction="row" alignItems="center">
            <Image src="https://res.cloudinary.com/dbduj98i3/image/upload/v1635284886/credit-card_tlyfij.svg"/>
           ...
           <Stack cursor="pointer"  paddingBottom="1.6rem" paddingLeft="2rem" direction="row" alignItems="center">
